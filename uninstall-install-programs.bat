...
:: UNINSTALL COPILOT (removes M365 Office Hub, no admin required)
echo [Copilot] Uninstalling...
taskkill /F /IM Copilot.exe 2>nul
powershell -ExecutionPolicy Bypass -Command "Get-AppxPackage -Name Microsoft.MicrosoftOfficeHub | Remove-AppxPackage"
echo [Copilot] Done.
